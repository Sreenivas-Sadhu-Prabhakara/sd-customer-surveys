package com.bank.bian.customersurveys.model;
...
/**
 * The BIAN control record for this service domain: "Customer Survey Operating Session".
 *
 ...
 * to its asset type (Customer Survey). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Customer Survey Operating Session";
